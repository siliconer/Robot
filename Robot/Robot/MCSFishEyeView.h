...
- (void)fishEyeView:(MCSFishEyeView *)fishEyeView advanceSetting:(NSInteger)advancedSettingNo;
- (void)fishEyeView:(MCSFishEyeView *)fishEyeView cameraMode:(NSInteger)cameraModeNo;
...
- (void)deselectSelectedItemAnimated:(BOOL)animated index:(NSInteger)selectedIndex; // will not notify delegate
