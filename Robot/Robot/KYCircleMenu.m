...
@property (nonatomic, strong) NSString * buttonImageNameFormat,
...
//  CGRect frame = CGRectMake(0.f, 0.f, kKYCircleMenuViewWidth, viewHeight);
    CGRect frame = CGRectMake(0.f, 0.f, 150, 130);
...
- (void)viewDidLoad {
  ...
  // Main Button
    CGRect mainButtonFrame =CGRectMake(60, 50, 30, 30);
//    CGRect mainButtonFrame =CGRectMake((CGRectGetWidth(self.view.frame) - centerButtonSize_) / 3.f,
//               (CGRectGetHeight(self.view.frame) - centerButtonSize_) / 3.f,
//               centerButtonSize_, centerButtonSize_);
    ...
    [centerButton_ setBackgroundColor:[UIColor yellowColor]];
