...
//    self.autoresizingMask = UIViewAutoresizingFlexibleWidth|UIViewAutoresizingFlexibleHeight;
    _markerValueColor = [UIColor redColor];
//    _tvSliderView = [[TVSlider alloc] initWithFrame:CGRectMake(self.frame.size.width/2, 0, 20,self.frame.size.height/2)];
    
    _tvSliderView = [[TVSlider alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width*1.5,self.frame.size.height)];
...
//    float scaleFactor = (_tvSliderView.frame.size.height - thumbImage.size.width) / (_tvSliderView.maximumValue - _tvSliderView.minimumValue);
//    [_markerValueColor set];
//    
//    for(int index = 0 ; index + _tvSliderView.minimumValue <= _tvSliderView.maximumValue ; index ++){
//        float x = (scaleFactor * index) + thumbImage.size.width/2+_tvSliderView.center.x+20 ;
//        float y = _tvSliderView.center.x + _markerImage.size.height +_markerImageOffsetFromSlider+10    ;
//        
...
//        markerImageView.frame = CGRectMake(y, x, _markerImage.size.height, _markerImage.size.width);
//
