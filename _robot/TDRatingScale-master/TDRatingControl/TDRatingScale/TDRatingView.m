...
//    containerView.backgroundColor = self.scaleBgColor;
    containerView = [[UIView alloc]initWithFrame:CGRectMake(0, self.sliderHeight, self.heightOfEachNo,self.frame.size.width)];
...
-(void)createSliderView
{
    ...
    sliderView = [[UIView alloc]initWithFrame:CGRectMake(self.spaceBetweenEachNo, 0, self.frame.size.height,self.widthOfEachNo)];
...
//    [sliderView addSubview:upArrow];
    ...
    TDArrow *triangleUp = [[TDArrow alloc]initWithFrame:CGRectMake(0, 0, upArrow.frame.size.height, upArrow.frame.size.width) arrowColor:self.arrowColor strokeColor:self.sliderBorderColor isUpArrow:YES];
...
//    [sliderView addSubview:downArrow];
    ...
    TDArrow *triangleDown = [[TDArrow alloc]initWithFrame:CGRectMake(0, 0, upArrow.frame.size.height, upArrow.frame.size.width) arrowColor:self.arrowColor strokeColor:self.sliderBorderColor isUpArrow:NO];
...
//        UILabel *lblMyLabel = [[UILabel alloc] initWithFrame:CGRectMake(itemX, itemY, self.widthOfEachNo, self.heightOfEachNo)];
        UILabel *lblMyLabel = [[UILabel alloc] initWithFrame:CGRectMake(itemY, itemX, self.widthOfEachNo, self.heightOfEachNo)];
        ...
        itemX = lblMyLabel.frame.origin.y + self.widthOfEachNo + self.spaceBetweenEachNo;
...
- (void)handleTap:(UIPanGestureRecognizer *)recognizer {
    ...
    float tappedViewX = recognizer.view.frame.origin.y;
    ...
    sliderFrame.origin.y = tappedViewX;
...
- (void)handlePan:(UIPanGestureRecognizer *)recognizer {
    ...
    CGFloat newY = MIN(recognizer.view.frame.origin.y+ translation.y, self.frame.size.height - recognizer.view.frame.size.height);
    CGRect newFrame = CGRectMake( newY,recognizer.view.frame.origin.x, recognizer.view.frame.size.height, recognizer.view.frame.size.width);
