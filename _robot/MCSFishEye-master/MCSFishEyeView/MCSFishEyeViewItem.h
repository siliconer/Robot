...
-(void)setDeselected:(BOOL)animated NS_REQUIRES_SUPER;
- (void)setInitColor:(NSInteger)itemIndex NS_REQUIRES_SUPER;
- (void)colorImgManupuplate:(NSInteger)itemIndex selected:(NSInteger)selected NS_REQUIRES_SUPER;
