...
- (void)viewDidLoad
{
  ...
  self.leftFishEyeView.contentInset = UIEdgeInsetsMake(0.0, 5.0, 0.0, 0.0);
...
{
  return fishEyeView == self.rightFishEyeView ? 6 : 6;
}
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
  ...
  if([touch.view isKindOfClass:MCSFishEyeView.class]){
    NSLog(@"iskindoff");
  }
  for (MCSFishEyeView *fishEye in self.fishEyeViews) {
